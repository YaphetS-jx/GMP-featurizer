...
namespace gmp { namespace mcsh {
    ...
    template <typename T>
    GPU_HOST_DEVICE constexpr T P3(const T lambda_x0, const T lambda_x0_3, const T inv_gamma);
    
    template <typename T>
    GPU_HOST_DEVICE constexpr T P4(const T lambda_x0_2, const T lambda_x0_4, const T inv_gamma, const T inv_gamma_2);
    
    template <typename T>
    GPU_HOST_DEVICE constexpr T P5(const T lambda_x0, const T lambda_x0_3, const T lambda_x0_5, const T inv_gamma, const T inv_gamma_2);
    
    template <typename T>
    GPU_HOST_DEVICE constexpr T P6(const T lambda_x0_2, const T lambda_x0_4, const T lambda_x0_6, 
        const T inv_gamma, const T inv_gamma_2, const T inv_gamma_3);
    
    template <typename T>
    GPU_HOST_DEVICE constexpr T P7(const T lambda_x0, const T lambda_x0_3, const T lambda_x0_5, const T lambda_x0_7, 
        const T inv_gamma, const T inv_gamma_2, const T inv_gamma_3);
    
    template <typename T>
    GPU_HOST_DEVICE constexpr T P8(const T lambda_x0_2, const T lambda_x0_4, const T lambda_x0_6, const T lambda_x0_8, 
        const T inv_gamma, const T inv_gamma_2, const T inv_gamma_3, const T inv_gamma_4);
    
    template <typename T>
    GPU_HOST_DEVICE constexpr T P9(const T lambda_x0, const T lambda_x0_3, const T lambda_x0_5, const T lambda_x0_7, const T lambda_x0_9, 
        const T inv_gamma,  const T inv_gamma_2, const T inv_gamma_3, const T inv_gamma_4);
