...
namespace gmp { namespace resources {
    ...
    public:
        ...
        constexpr static size_t DEFAULT_NODE_SIZE = 64;         // default for 64 bytes memory for node size
        constexpr static size_t DEFAULT_NEXT_SIZE = (1<<20);    // default for 1MB memory for next block size 
